...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-turnstile.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-turnstile)
...
```bash
php artisan vendor:publish --tag="laravel-turnstile-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-turnstile-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-turnstile-views"
```

## Usage

```php
$turnstile = new NjoguAmos\Turnstile();
echo $turnstile->echoPhrase('Hello, NjoguAmos!');
```
